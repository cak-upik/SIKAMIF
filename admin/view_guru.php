            ...
            <div class="row-fluid">
                ...
                <table class="table-bordered">
                    ...
                    if ($kategori AND $key) {
                        ...
                        javascript:window.opener.document.forms[0].nip.value = '<?php echo $row[nip]; ?>';
                        javascript:window.opener.document.forms[0].nama.value = '<?php echo $nama_guru; ?>';
                        javascript:window.opener.document.forms[0].id_guru.value = '<?php echo $row[id]; ?>'">
