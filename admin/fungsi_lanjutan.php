...
order by siswa.NIS";
    ...
    while ($row = mysql_fetch_array($hasil)) {
        ...
        <tr bgcolor="<?php echo $warna; ?>">
            ...
            <td align="center"><?php echo $row[NIS]; ?></td>
            <td><?php echo $row[NAMA_LENGKAP]; ?></td>
            <td align="center"><a href="?act=detil_isi&id=<?php echo $row[ID]; ?>&tahun_ajaran=<?php echo $tahun_ajaran; ?>&kelas_id=<?php echo $kelas_id; ?>&key=<?php echo $key; ?>&kategori=<?php echo $kategori; ?>&semester=0" class="btn"><i class="icon-folder-open"></i>Buka</a></td>
        </tr>
        <?php
    }
    mysql_free_result($hasil);
