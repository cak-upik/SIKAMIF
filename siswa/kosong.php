        ...
        <div class="span20">
            <div style="margin-left: 450px;">
                <table class="table-bordered">
                    ...
                    <tr> 
                        <td>
                            <img src="../admin/images/orphans.png" width="48" height="48" border="0"><br>
                            <br>
                        </td>
                        <td>Silahkan pilih Kelas Anda pada Tahun Ajaran yang sesuai</td>
                    </tr>
                    <tr> 
                        <td colspan="3"> 
                            <input name="button" type="button" class="btn" onClick="window.close();" value="Close">
                        </td>
                    </tr>
                </table>
            </div>
