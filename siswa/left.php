...
<div class="span2">
    <div class="well sidebar-nav">
        <ul class="nav nav-list">
            ...
            <li><a href="data_pribadi.php">Data Diri Siswa</a></li>
            ...
            <li><a href="page_maintenance.php">Rekap Absen</a></li>
			<li><a href="page_maintenance.php">Pengumuman</a></li>
			<li><a href="page_maintenance.php">Lihat Nilai</a></li>
			<li><a href="page_maintenance.php">Data Peringkat Nilai</a></li>
